...
from app.api import (
    admin, ai, assistant, attachments, auth, export, health, init_assistant, knowledge, memories, projects, review, sections, settings, share, skills, tags, templates, versions,
)
...
# /assistant/* ChatGPT 式初始化助手顶层会话（替代 init_assistant，Task 10 删旧）
