...
def friendly_llm_error(e: Exception) -> str:
    ...
    # 429 / 402 / 余额不足 / 配额耗尽（智谱 1113 / DeepSeek 402 Insufficient Balance / 通用 RateLimit）
    if (
        "429" in msg or "402" in msg or "RateLimit" in type(e).__name__
        or "余额不足" in msg or "无可用资源包" in msg
