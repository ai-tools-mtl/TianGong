...
def test_rag_search_tool_is_registered():
    ...
    tools = asyncio.run(create_agent_tools(db=None, user_id="00000000-0000-0000-0000-000000000001"))
    rag = tools[0]
...
def test_rag_search_tool_invalid_user_id_returns_empty():
    ...
    from app.ai.tools import create_agent_tools
    tools = asyncio.run(create_agent_tools(db=None, user_id="not-a-uuid"))
